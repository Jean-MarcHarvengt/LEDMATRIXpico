...
//#define R16(rgb) (((rgb >> 11) & 0x1F)<<3)
//#define G16(rgb) (((rgb >> 5) & 0x3F)<<2)
//#define B16(rgb) ((rgb & 0x1F)<<3) 
...
class TFT_T_DMA
{
  ...
  void startDMA(void);
  void stopDMA();
  void allocate_frame_buffer(void);
  ...
  void copyBlockNoDma(int x, int y, int w, int h, const uint16_t *pcolors);
